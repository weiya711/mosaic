...
static void bench_suitesparse_elemadd_mkl(benchmark::State& state, bool gen=true, int fill_value=0) {
...
TACO_BENCH_ARGS(bench_suitesparse_elemadd_mkl, mat_elemadd_mmadd, true)->UseRealTime();
