...
static void bench_suitesparse_spmv_mkl(benchmark::State& state, bool gen=true, int fill_value=0) {
...
TACO_BENCH_ARGS(bench_suitesparse_spmv_mkl, vecmul_spmv, true)->UseRealTime();
