...
static void bench_suitesparse_residual_taco(benchmark::State& state, bool gen=true, int fill_value=0) {
...
TACO_BENCH_ARGS(bench_suitesparse_residual_taco, mat_residual, false)->UseRealTime();
